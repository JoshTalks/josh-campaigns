"""
Django settings for joshCampaigns project.
...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,0.0.0.0,34.14.212.129').split(',')
...
ROOT_URLCONF = "joshCampaigns.urls"
...
WSGI_APPLICATION = "joshCampaigns.wsgi.application"
